  ...
  return (
    <main className="mobile-page success-page">
      <section className="mobile-card success-card">
        ...
        <h1>{candidate?.name ?? '候选人'}，你的岗位预体验已完成</h1>
        <p>{job?.title ?? '目标岗位'} 的故事卡已同步到HR工作台。HR会结合人工复核结果安排后续沟通。</p>
        <div className="success-actions">
          <Link className="primary-button full" to="/hr/candidates">HR查看故事卡</Link>
          <Link className="ghost-button full" to="/">返回演示入口</Link>
        </div>
      </section>
    </main>
  );
